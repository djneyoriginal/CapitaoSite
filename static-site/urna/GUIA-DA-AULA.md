...
A consulta oficial de São Paulo é de 22/09/2026: 1.131 registros federais, 1.431 estaduais e 16 de Senado. A página usa uma cópia datada; não consulta o TSE automaticamente. A lista presidencial tem outra procedência, identificada no próprio código.
...
4. Confirme presidente. A apuração só muda quando as cinco escolhas terminam. Nessa etapa, 13 identifica Lula.
...
O simulador é educativo e não reproduz integralmente o sistema eleitoral. Governador não está incluído nesta versão. A recompensa mostra liderança local por votos; não calcula eleição proporcional, quocientes ou distribuição oficial de cadeiras.
